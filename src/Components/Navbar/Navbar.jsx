    ...
    <nav className="bg-[#F8F9FA] border-gray-200 fixed top-0 left-0 w-full z-50 shadow-md px-3">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
        ...
        <div
          ...
          id="navbar-default"
        >
          <ul className="font-medium flex flex-col md:flex-row p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
            {token && (
              <>
                {[
                  { to: "/", label: "Home" },
                  ...
                  <li key={to} className="relative">
                    <NavLink
                      to={to}
                      className={({ isActive }) =>
                        `block py-2 px-3 rounded-sm md:p-0 transition-colors duration-200 text-center ${
                          isActive
                            ? "  text-[#4FA74F]"
